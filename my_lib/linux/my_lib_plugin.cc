...
class MyLibPlugin : public flutter::Plugin {
 public:
...
// static
void MyLibPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarGlfw *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "my_lib",
          &flutter::StandardMethodCodec::GetInstance());
  auto plugin = std::make_unique<MyLibPlugin>();
...
MyLibPlugin::MyLibPlugin() {}

MyLibPlugin::~MyLibPlugin() {}

void MyLibPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void MyLibPluginRegisterWithRegistrar(
  ...
  MyLibPlugin::RegisterWithRegistrar(insert_result.first->second.get());
}
